package org.l2kserver.game.domain.shortcut
...
enum class ShortcutType(val id: Int) {
    @JsonProperty("item") ITEM(1),
    @JsonProperty("skill")SKILL(2),
    @JsonProperty("action")ACTION(3),
    @JsonProperty("macro")MACRO(4),
    @JsonProperty("recipe")RECIPE(5);
