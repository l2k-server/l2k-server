...
data class BasicStats(
    ...
    companion object {
        ...
        @JsonCreator
        fun create(
            @JsonProperty("STR") str: Int = 0,
            @JsonProperty("DEX") dex: Int = 0,
            @JsonProperty("CON") con: Int = 0,
            @JsonProperty("INT") int: Int = 0,
            @JsonProperty("WIT") wit: Int = 0,
            @JsonProperty("MEN") men: Int = 0
        ) = BasicStats(
            str = STR(str),
            dex = DEX(dex),
            con = CON(con),
