 ...
 *
 * @property ssItemId Soulshot item identifier
 * @property enable If true - enable auto usage, false - disable
 */
data class AutoUseSsRequest(val ssItemId: Int, val enable: Boolean): ExtendedRequestPacket {
    constructor(data: ByteBuffer): this(ssItemId = data.getInt(), enable = data.getInt() > 0)
}
